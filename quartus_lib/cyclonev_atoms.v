...
module    cyclonev_crcblock    (
	...
	defparam inst.error_dra_dl_bypass = error_dra_dl_bypass;
	defparam inst.crc_deld_disable = crc_deld_disable;
	defparam inst.triple_adj_err_correction = triple_adj_err_correction;
	defparam inst.quad_adj_err_correction = quad_adj_err_correction;
    defparam inst.lpm_type = lpm_type;
...
parameter hphy_datapath_ac_delay = "zero_cycles";
...
defparam inst.hphy_datapath_ac_delay = hphy_datapath_ac_delay;
